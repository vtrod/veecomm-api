...
func (cu *CategoryUpdate) AddProductIDs(ids ...string) *CategoryUpdate {
...
func (cu *CategoryUpdate) RemoveProductIDs(ids ...string) *CategoryUpdate {
...
// AddProductIDs adds the "products" edge to the Product entity by IDs.
func (cuo *CategoryUpdateOne) AddProductIDs(ids ...string) *CategoryUpdateOne {
...
// RemoveProductIDs removes the "products" edge to Product entities by IDs.
func (cuo *CategoryUpdateOne) RemoveProductIDs(ids ...string) *CategoryUpdateOne {
